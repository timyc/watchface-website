...
<template>
    <!-- Battery icon -->
    <svg width="0.2" height="0.4" x="0.3" y="2.25" viewBox="0 0 22 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <line x1="0" y1="1.1" x2="100" y2="1.1" stroke="white" stroke-width="0.02px" />
    <line x1="0" y1="2.25" x2="100" y2="2.25" stroke="white" stroke-width="0.02px" />
</template>