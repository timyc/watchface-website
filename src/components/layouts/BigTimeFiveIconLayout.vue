...
<template>
    ...
    <StatisticItem v-if="(settingsStore.fields.length == 0 || settingsStore.fields.length >= 5) && settingsStore.theme !== 'multimodern'" :stat="settingsStore.fields.length == 0 ? null : settingsStore.fields[4]" :coords="layouts[layout == null ? settingsStore.layout as keyof typeof layouts : layout as keyof typeof layouts].stats[4]" :iconColor="settingsStore.iconColor" :textColor="settingsStore.iconTextColor"/>
    <StatisticItem v-if="(settingsStore.fields.length == 0 || settingsStore.fields.length >= 5) && settingsStore.theme === 'multimodern'" :stat="settingsStore.fields.length == 0 ? null : settingsStore.fields[4]" :coords="layouts[layout == null ? settingsStore.layout as keyof typeof layouts : layout as keyof typeof layouts].stats[4]" :iconColor="settingsStore.uniqueIconColor[4]" :textColor="settingsStore.uniqueIconColor[4]"/>
