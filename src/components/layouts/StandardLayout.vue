...
<template>
    ...
    <StatisticItem v-if="settingsStore.fields.length == 0 || settingsStore.fields.length >= 4" :stat="settingsStore.fields.length == 0 ? null : settingsStore.fields[3]" :coords="layouts[layout == null ? settingsStore.layout as keyof typeof layouts : layout as keyof typeof layouts].stats[3]" />
    <text :x="layouts[layout == null ? settingsStore.layout as keyof typeof layouts : layout as keyof typeof layouts].interface[0].x" :y="layouts[layout == null ? settingsStore.layout as keyof typeof layouts : layout as keyof typeof layouts].interface[0].y" font-size="0.5px" :fill="settingsStore.aesthetic == null ? 'white' : aesthetics[settingsStore.aesthetic as keyof typeof aesthetics].theme[2]">10:12</text>
