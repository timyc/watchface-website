...
<template>
    <!-- These aesthetics settings are displayed when the theme is not multimodern -->
    ...
    <!-- 
        ...
        - The main difference is just that there are now n number of icon color choices
    -->
    <div v-if="settingsStore.theme != null && settingsStore.theme === 'multimodern'">
        <h2>Apply an aesthetic</h2>
