...
<template>
    <svg width="0.4" height="0.4" :x="coords.x1" :y="coords.y1" viewBox="0 0 22 12">
        <image width="100%" height="100%"
            ...
            :style="{ 'filter': hexToCSSFilter(settingsStore.aesthetic == null ? (settingsStore.iconColor == null ? '#FFFFFF' : themes[settingsStore.theme as keyof typeof themes].default[2]) : settingsStore.iconColor).filter.slice(0, -1) }" />
    </svg>
    <text :x="coords.x2" :y="coords.y2" dominant-baseline="middle" text-anchor="middle"
