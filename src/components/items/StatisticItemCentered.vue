...
<template>
    ...
    <text :x="coords.x2" :y="coords.y2" dominant-baseline="middle" text-anchor="middle" :fill="settingsStore.aesthetic == null ? '#FFFFFF' : aesthetics[settingsStore.aesthetic as keyof typeof aesthetics].theme[2]" :font-size="size">
    {{ //@ts-ignore 
